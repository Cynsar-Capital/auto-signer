...
def sign_pdf(input_pdf_path, temp_pdf_path, output_pdf_path, signatures, identifiers, check_proximity=False, adjust_coords=False, reference_text_distance=30, spacing=5, force_refined=False, offset_increment=0, scale_factor=0):
